...
export default function Profile({ params }) {
  ...
  const getUser = async () => {
    try {
      const url = `http://localhost:8080/api/superAdmin/getUserDetails/${userId}`;
  ...
  async function handleDetailsSubmit(e) {
    ...
    try {
      ...
      setLoading(true);
      setError(null);
      const url = "http://localhost:8080/api/superAdmin/changeUserDetails";
  ...
  async function handlePasswordSubmit(e) {
    ...
    try {
      ...
      setLoading(true);
      setError(null);
      const url = "http://localhost:8080/api/superAdmin/changeUserPassword";
